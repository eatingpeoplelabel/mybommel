...
export default function ClientSharePic({ bommel }: { bommel: any }) {
  ...
  return (
    <div className="w-full flex flex-col items-center p-4">
      {/* Container that maintains 1080:1920 aspect ratio */}
      <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg" style={{ paddingTop: '177.78%' }} ref={ref}>
        <svg
        ...
        >
          ...
          <g transform="translate(0,288)">
            ...
            <text x="540" y="460" textAnchor="middle" fontSize="37" fontFamily="Montserrat, sans-serif" fill="#fff">
      ...
      <button
        ...
        className="mt-6 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-full shadow-lg"
