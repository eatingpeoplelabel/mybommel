...
export default function ClientSharePic({ bommel }: { bommel: any }) {
  ...
  // preload remote bommel image as base64
  useEffect(() => {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-4">
      <div
        ...
        style={{paddingTop: '177.78%'}} // 1920/1080 = 1.7778
      >
        <div className="absolute inset-0">
          ...
          >
            ...
            <g transform="translate(0,288)">
              <defs>
                <clipPath id="clip"><circle cx="540" cy="270" r="250"/></clipPath>
              </defs>
              <circle cx="540" cy="270" r="254" fill="none" stroke="#fff" strokeWidth="4"/>
              {imageDataUrl && <image href={imageDataUrl} x="290" y="20" width="500" height="500" clipPath="url(#clip)" />}
              <rect x="390" y="425" width="300" height="54" rx="27" fill="#8e24aa"/>
              <text x="540" y="460" textAnchor="middle" fontSize="37" fontFamily="Montserrat, sans-serif" fill="#fff">No. {bommel.bommler_number}</text>
              <rect x="140" y="570" width="800" height="70" rx="35" fill="#ffffffcc" stroke="#8e24aa" strokeWidth="4"/>
              <text x="540" y="620" textAnchor="middle" fontFamily="Bangers, sans-serif" fontSize="50" fill="#8e24aa">I AM AN OFFICIAL BOMMLER</text>
            ...
            <g>
              ...
              <text x="540" y="1430" textAnchor="middle" fontSize="30" fill="#fff">Ready to fluff the world?</text>
              <text x="540" y="1490" textAnchor="middle" fontSize="30" fill="#ffff00"><tspan fontWeight="700">mybommel.com</tspan> by Bebetta with Love</text>
            </g>
          </svg>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-4">
        <button
          ...
          className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-full shadow"
        >📸 Download Sharepic</button>
      </div>
    </div>
  )
}
