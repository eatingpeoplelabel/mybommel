...
export default function Legal() {
  return (
    <>
      <Head>
        <title>Legal & Fluffformation – Bommelverse</title>
        <meta name="description" content="Legal notice and privacy information for the Bommelverse website." />
        <meta property="og:title" content="Legal & Fluffformation – Bommelverse" />
        <meta property="og:description" content="Legal notice and privacy information for the Bommelverse website." />
        <meta property="og:url" content="https://mybommel.com/legal" />
        <meta name="twitter:card" content="summary" />
        <link rel="canonical" href="https://mybommel.com/legal" />
      </Head>
